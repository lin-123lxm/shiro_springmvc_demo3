...
<body>
<div class="pd-20">
    <form action="dosubmitAdd.do" method="post" class="form form-horizontal">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="roleDesc" class="textarea"></textarea>
            </div>
            <div class="col-5"></div>
        </div>
            ...
            <div class="formControls col-6" >
                ...
                <c:forEach items="${permissionList}" var="permissions">
                    ...
                    <div class="col-3" id="chechALL">
                        <input type="checkbox" name="rolePerssionId" value="${permissions.id }" id="permissionId4" />
                        <label for="permissionId4">${permissions.description }</label>
                        <br/>
                    </div>
