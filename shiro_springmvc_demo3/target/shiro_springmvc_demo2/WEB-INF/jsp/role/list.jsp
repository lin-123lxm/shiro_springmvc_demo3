...
<script type="text/javascript">
    ...
    function goRolePermission(roleId){
       // window.location="${ctxPath}/toeditRolePermission.do?roleId="+roleId;
    }
    ...
    <table class="table table-border table-bordered table-bg table-hover">
        <thead>
            <tr>
                ...
                <th>描&nbsp;&nbsp;述</th>
                <th>操&nbsp;&nbsp;作&nbsp;
                    <shiro:hasPermission name="role:createRole">
     ...
     <c:forEach var="roles" items="${rolelist}">
                <tr>
                    ...
                    <td>                   	
                       ...
                       <shiro:hasPermission name="role:updateRolePermissions">
                           <button class="btn size-MINI btn-secondary radius" onclick="window.location.href='toeditRolePermission.do?roleId=${roles.id}'">分配权限</button>
                       </shiro:hasPermission>
