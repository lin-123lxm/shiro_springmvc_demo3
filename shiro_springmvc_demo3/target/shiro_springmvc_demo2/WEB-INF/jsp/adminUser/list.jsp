            ...
            <tr>
                ...
                <td>
                    ...
                    <shiro:hasPermission name="adminUser:updateAdminUserRole">
                        <button class="btn size-MINI btn-secondary radius" onclick="window.location='updateAdminUserRole.do?adminUserId=${adminUserList.id}'">分配角色</button>&nbsp;
                    </shiro:hasPermission>
                    <shiro:hasPermission name="adminUser:updateDisabled">
                        <button class="btn size-MINI btn-warning radius" onclick="window.location='updateAdminUserDisable.do?adminUserId=${adminUserList.id}'">禁用/启用</button>
                    </shiro:hasPermission>
...
<%--    分页页面 通过动态包含将page.jsp的分页信息包含到当前页面中。 --%>
